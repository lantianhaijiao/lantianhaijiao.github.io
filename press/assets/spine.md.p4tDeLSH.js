...
<span class="line"><span>);</span></span></code></pre></div><h5 id="如果没有匹配到文件-提示错误" tabindex="-1">如果没有匹配到文件，提示错误 <a class="header-anchor" href="#如果没有匹配到文件-提示错误" aria-label="Permalink to &quot;如果没有匹配到文件，提示错误&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark has-focused-lines vp-code" tabindex="0"><code><span class="line"><span>if (jsonPath &amp;&amp; atlasPath){</span></span>
<span class="line"><span>  // 正常处理</span></span>
<span class="line"><span>} else {</span></span>
<span class="line"><span>  vscode.window.showErrorMessage(</span></span>
<span class="line has-focus"><span>    &quot;在文件夹中未找到匹配的 Spine JSON 和 ATLAS 文件。&quot;</span></span>
<span class="line"><span>  );</span></span>
